    ...
    >
      <div className="flex flex-col items-center p-6">
        <div className="mb-6 relative">
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#9b87f5] to-[#7E69AB] blur-md opacity-70 transform scale-105 group-hover:scale-110 group-hover:opacity-90 transition-all duration-300"></div>
        ...
        <div className="flex-1 text-center">
          <motion.h3 
            className="text-xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent mb-1"
